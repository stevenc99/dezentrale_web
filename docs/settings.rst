...
These are the default settings in :file:`dezentrale_web/manage.py`.
...
.. list-table::
    ...
    * - ``DJANGO_SETTINGS_MODULE``
      - ``'dezentrale_web.config.settings.dev'``
      - ``DJANGO_SETTINGS_MODULE``
...
:py:class:`dezentrale_web.config.settings.common.Common`.
...
.. list-table::
    ...
    * - ``MIDDLEWARE_CLASSES``
      ...
      - | A list of middleware classes to
        | use.
    * - ``MEDIA_ROOT``
      - ``'<full path to dezentrale_web>/media/'``
      - ``DJANGO_MEDIA_ROOT``
    ...
    * - ``STATIC_ROOT``
      - ``'<full path to dezentrale_web>/static_root/'``
      - ``DJANGO_STATIC_ROOT``
...
:py:class:`dezentrale_web.config.settings.databases.Databases`.

The following classes inherit from it:

* :py:class:`dezentrale_web.config.settings.dev.Development`
* :py:class:`dezentrale_web.config.settings.public.Production`
* :py:class:`dezentrale_web.config.settings.public.Staging`
* :py:class:`dezentrale_web.config.settings.test.Testing`
...
:py:class:`dezentrale_web.config.settings.email.SMTP`
...
from :py:class:`dezentrale_web.config.settings.email.Mailgun`
to use these settings.
...
from :py:class:`dezentrale_web.config.settings.public.Raven`
to use these settings.
...
The class
:py:class:`dezentrale_web.config.settings.public.Public`
...
from :py:class:`dezentrale_web.config.settings.public.SSL`
to use these settings.
:py:class:`dezentrale_web.config.settings.public.Production`

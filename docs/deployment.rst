...
First install the ``dezentrale_web`` package. It is very useful
...
::
    ...
    $ pip install dezentrale_web[mailgun]
...
::
    ...
    $ pip install dezentrale_web[raven]
...
::
    ...
    $ echo "dezentrale_web.config.settings.public" > envs/prod/DJANGO_SETTINGS_MODULE

...
<https://github.com/bocian67/dezentrale_web/issues>`_.
...
dezentrale_web could always use more documentation, whether as
part of the official dezentrale_web docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `dezentrale_web` for
local development.

1. Fork the `dezentrale_web` repo on GitHub.
2. Clone your fork locally:

    ::

       $ git clone git@github.com:your_name_here/dezentrale_web.git
...
3. The pull request should work for Python 2.7 and 3.5. Check
   `Travis CI <https://travis-ci.org/bocian67/dezentrale_web/pull_requests>`_
